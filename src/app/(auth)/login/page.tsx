        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 animate-fade-in">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1.5">Use the password provided by your administrator</p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-400">
              Need help? Ask <span className="text-bdja-secondary font-medium">Joy</span> anytime
            </p>
          </div>
        </div>
