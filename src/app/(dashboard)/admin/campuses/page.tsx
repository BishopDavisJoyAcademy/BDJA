  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500">Manage school campuses</p>
      </div>
      <Card className="p-6">
        <div className="flex items-center gap-4">
          <MapPin className="w-5 h-5 text-bdja-primary" />
          <span className="font-medium">Campus List</span>
        </div>
        <p className="text-gray-500 text-sm mt-2">Campus management will appear here.</p>
      </Card>
    </div>
  );
}
