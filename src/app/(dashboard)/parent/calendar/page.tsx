"use client";
// Parent calendar — same functionality as student calendar
    ...
    <div className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-0.5">View upcoming school events and important dates for your children</p>
        </div>
      </motion.div>
