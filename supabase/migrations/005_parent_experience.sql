-- ============================================================
-- 005_parent_experience
-- Parent experience: parent-teacher messaging, announcements, read receipts, staff activity logs, fee payment flexibility.
--
-- BDJA Platform — Version 1.0.0
-- Consolidated from: 20240905_parent_experience, 017 (staff_activity_logs; guardian columns folded into 001)
--
