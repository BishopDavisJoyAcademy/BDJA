-- ============================================================
-- 009_storage
-- Storage: bdja-uploads bucket (ID = name, the correct configuration) with RLS policies for avatars and attachments. Diagnostic from 007 folded into verification queries below.
--
-- BDJA Platform — Version 1.0.0
-- Consolidated from: 006_storage_bucket, 009_fix_storage_bucket_id (merged — bucket created correctly the first time), 007_upload_diagnostic (SELECTs preserved)
--
...
-- ( informational — safe to run; confirms the bucket and policies )
-- ============================================
